			...
			<div class="js-checkout-address-box">
				<div class="gray-box clear">
					<div class="title columns-title pre-title">
						<h2>发票收件或联系地址地址</h2>
						<el-link type="info" style="float: right;" @click="showx=!showx">管理地址</el-link>
					</div>
					<div class="box-inner js-checkout-address-panel ">
						<div class="address-common-table js-multiple-address-panel">
							<ul class="address-item-list clear js-address-item-list">
								<li class="js-choose-address" :class="{'selected-address-item':receiveIndex==index}" v-for="item,index in receiveInfo" @click="checkReceive(index)"><el-link type="info" @click="removeadd(item.id)" style="float: right;color:#424242;font-size: 24px;" class="el-icon-delete-solid" :underline="false" v-if="showx"></el-link>
			...
			<div class="gray-box">
				...
				<div class="box-inner"> 
					<div class="last-payment clear"> 
						<span class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout" @click="topay"> <a>提交订单</a> </span> 
						<span class="prices fn-right">应付金额： <em v-if="checkedGoods.count>88">¥ {{checkedGoods.count}}.00</em>
						<em v-else>¥ {{checkedGoods.count+8}}.00</em>
						</span> 
					</div> 
				</div>
			</div>
