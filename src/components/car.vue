<template>
	<div style="display: flex;height: 100px;position: absolute;left:320px">
	      <transition name="el-fade-in-linear" >
	        <div class="transition-box" v-show="show1" style="width: 600px;height: 700px;">
			<div style="font-size: 24px;width: 580px;border-bottom: 1px solid rgba(0,255,255);">收藏夹
			...
			:header-cell-style="tableHeaderColor" style="margin-top: 20px;">
					    ...
					    <el-table-column property="sku_id" label="订单编号" width="110"></el-table-column>
						<el-table-column property="title" label="订单名" width="140"></el-table-column>
